...
component_title = d.css('.component-detail h1').first.text.gsub(component_version, '').strip.gsub("&", "and")
component_summary = d.css(".component-detail .description p").text.gsub("&", "and")
component_description = d.css(".component-about p").first.text.gsub("&", "and")
